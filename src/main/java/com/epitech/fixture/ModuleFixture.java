...
public class                    ModuleFixture {
    ...
    public void             init() {
        ...
        this.add(new Module("drive", "/img/modules/googledrive.png", "Description for googledrive", "https://accounts.google.com/o/oauth2/v2/auth?client_id=801969793224-jh02oeqpfvi2ocjrebbp21dks178qav5.apps.googleusercontent.com&redirect_uri=http://localhost:8080/module/oauth&response_type=token&scope=https://www.googleapis.com/auth/drive"));
